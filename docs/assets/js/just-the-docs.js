...
{"0": {
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/mplab_harmony_license.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/time/sys_time_multiclient/readme.html#time-system-service-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/time/sys_time_multiclient/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/system/time/sys_time_multiclient/readme.html#setting-up-at91bootstrap-loader"
  },"5": {
    "doc": "Time System Service multi-client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Setting up the board . | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/time/sys_time_multiclient/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/system/time/sys_time_multiclient/readme.html#setting-up-the-hardware"
  },"6": {
    "doc": "Time System Service multi-client",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | Open the Terminal application (Ex.:Tera term) on the computer. | Connect to the (USB to Serial) COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Observe the following message getting printed on the console every two seconds . | Press the switch and observe the following output on the terminal (highlighted in red box) . | “Delay time = 500 ms” indicates the amount of time spent during the delay | “Single shot timer of 100 ms expired” is printed only once on every switch press | . | LED indicates the periodic timer functionality . | LED is toggled periodically every one second | . | . Refer to the following table for switch and LED name: . | Board | Switch Name | LED Name | . | SAM9X75-EB Evaluation Board | USER | RGB_LED(Blue) | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/time/sys_time_multiclient/readme.html#running-the-application",
    "relUrl": "/apps/system/time/sys_time_multiclient/readme.html#running-the-application"
  },"7": {
    "doc": "Time System Service multi-client",
    "title": "Time System Service multi-client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/time/sys_time_multiclient/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c/sync/i2c_eeprom/readme.html#i2c-driver-synchronous---i2c-eeprom",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#i2c-driver-synchronous---i2c-eeprom"
  },"9": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Description",
    "content": "This example uses the I2C driver in synchronous mode to communicate with the EEPROM to perform write and read operations in Bare-Metal environment. This application uses I2C driver to read and write data from an on-Board 24AA02E48T EEPROM device. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c/sync/i2c_eeprom/readme.html#description",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#description"
  },"10": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/i2c/sync/i2c_eeprom/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_9x75_eb_freertos.X | MPLABX project for SAM9X75-EB Evaluation Board | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c/sync/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"11": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c/sync/i2c_eeprom/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#setting-up-at91bootstrap-loader"
  },"12": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb_freertos.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Setting up the board . | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c/sync/i2c_eeprom/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#setting-up-the-hardware"
  },"13": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON when the value read from the EEPROM matched with the written value | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Green) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c/sync/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#running-the-application"
  },"14": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "I2C driver synchronous - I2C EEPROM",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c/sync/i2c_eeprom/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#i2c-eeprom-at24-driver---eeprom-read-write",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#i2c-eeprom-at24-driver---eeprom-read-write"
  },"16": {
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Description",
    "content": ". | This example uses the AT24 driver to communicate with I2C based on-board 24AA02E48 series EEPROM to perform write and read operations in Bare-Metal environment. | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#downloading-and-building-the-application"
  },"18": {
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#setting-up-at91bootstrap-loader"
  },"19": {
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Setting up the board . | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#setting-up-the-hardware"
  },"20": {
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | LED is turned ON when the data read from EEPROM matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Green) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html#running-the-application"
  },"21": {
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#sdmmc-driver-asynchronous---sdmmc-read-write",
    "relUrl": "/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#sdmmc-driver-asynchronous---sdmmc-read-write"
  },"23": {
    "doc": "SDMMC driver asynchronous - SDMMC Read Write",
    "title": "Description",
    "content": ". | This example uses the SDMMC driver in asynchronous mode in both Bare-Metal to perform Block Erase/Write/Read operations on SD-Card | This application writes 60KB (61440 bytes) of data starting at the SD Card memory location 0x2000 | It then reads and verifies the written data | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#downloading-and-building-the-application"
  },"25": {
    "doc": "SDMMC driver asynchronous - SDMMC Read Write",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#setting-up-at91bootstrap-loader"
  },"26": {
    "doc": "SDMMC driver asynchronous - SDMMC Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Addtional hardware required . | SD Card with FAT32 file system | . Setting up the board . | SDMMC slot used is SDMMC0 (J8) | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#setting-up-the-hardware"
  },"27": {
    "doc": "SDMMC driver asynchronous - SDMMC Read Write",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON when the read data from the SD Card matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Green) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#running-the-application",
    "relUrl": "/apps/driver/sdmmc/async/sdmmc_read_write/readme.html#running-the-application"
  },"28": {
    "doc": "SDMMC driver asynchronous - SDMMC Read Write",
    "title": "SDMMC driver asynchronous - SDMMC Read Write",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/sdmmc/async/sdmmc_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#spi-eeprom-at25-driver---eeprom-read-write",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#downloading-and-building-the-application"
  },"32": {
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#setting-up-at91bootstrap-loader"
  },"33": {
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Addtional hardware required . | EEPROM 4 Click board | . Setting up the board . | Insert EEPROM 4 Click board into MIKROBUS Connector. | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#setting-up-the-hardware"
  },"34": {
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON when the value read from EEPROM matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Blue) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html#running-the-application"
  },"35": {
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/async/usart_echo/readme.html#usart-driver-asynchronous---usart-echo",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/async/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/async/usart_echo/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#downloading-and-building-the-application"
  },"39": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/async/usart_echo/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#setting-up-at91bootstrap-loader"
  },"40": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Setting up the board . | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/async/usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#setting-up-the-hardware"
  },"41": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | Open the Terminal application (Ex.:Tera term) on the computer. | Connect to the (USB to Serial) COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Type a character and observe the output on the console as shown below: . | LED toggles each time the character is echoed | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Green) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/async/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#running-the-application"
  },"42": {
    "doc": "USART driver asynchronous - USART echo",
    "title": "USART driver asynchronous - USART echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/async/usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/sync/usart_echo/readme.html#usart-driver-synchronous---usart-echo",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/sync/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application"
  },"46": {
    "doc": "USART driver synchronous - USART echo",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/sync/usart_echo/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#setting-up-at91bootstrap-loader"
  },"47": {
    "doc": "USART driver synchronous - USART echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb_freertos.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Setting up the board . | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware"
  },"48": {
    "doc": "USART driver synchronous - USART echo",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | Open the Terminal application (Ex.:Tera term) on the computer. | Connect to the (USB to Serial) COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Type a character and observe the output on the console as shown below: . | LED toggles each time the character is echoed | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Green) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/sync/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#running-the-application"
  },"49": {
    "doc": "USART driver synchronous - USART echo",
    "title": "USART driver synchronous - USART echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/driver/usart/sync/usart_echo/readme.html",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html"
  },"50": {
    "doc": "FAT filesystem using RAM Media",
    "title": "FAT filesystem using RAM Media",
    "content": "This application shows an example of using the MPLAB Harmony File System to access RAM media . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/ram_fat/readme.html#fat-filesystem-using-ram-media",
    "relUrl": "/apps/fs/ram_fat/readme.html#fat-filesystem-using-ram-media"
  },"51": {
    "doc": "FAT filesystem using RAM Media",
    "title": "Description",
    "content": "Application defines below array for reserving region in RAM for Fat File system based on the Start address and size configured in MHC . #define KEEP __attribute__((keep, section(\\\".ram_nocache\\\"), address(DRV_MEMORY_DEVICE_START_ADDRESS))) /* Create an array for reserving region in RAM for Fat File system */ char CACHE_ALIGN RAM_FAT_MEDIA[DRV_MEMORY_DEVICE_MEDIA_SIZE_BYTES] KEEP; . File System Operations on the RAM: . | Performs a SYS_FS_FormatDisk | Opens a newfile.txt on the RAM | Write and reads back 4KB of data on newfile.txt | Verifies the Data Read back | . File system layer uses the following components . | One instance of the Memory driver is used to communicate with the RAM PLIB | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/ram_fat/readme.html#description",
    "relUrl": "/apps/fs/ram_fat/readme.html#description"
  },"52": {
    "doc": "FAT filesystem using RAM Media",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/fs/ram_fat/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_9x75_eb.X | MPLABX project for SAM9X75-EB Evaluation Board | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/ram_fat/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/ram_fat/readme.html#downloading-and-building-the-application"
  },"53": {
    "doc": "FAT filesystem using RAM Media",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/ram_fat/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/fs/ram_fat/readme.html#setting-up-at91bootstrap-loader"
  },"54": {
    "doc": "FAT filesystem using RAM Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Setting up the board . | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/ram_fat/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/ram_fat/readme.html#setting-up-the-hardware"
  },"55": {
    "doc": "FAT filesystem using RAM Media",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON if data has successfully been written and read back from file “newfile.txt” | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Green) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/ram_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/ram_fat/readme.html#running-the-application"
  },"56": {
    "doc": "FAT filesystem using RAM Media",
    "title": "FAT filesystem using RAM Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/ram_fat/readme.html",
    "relUrl": "/apps/fs/ram_fat/readme.html"
  },"57": {
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat/readme.html#fat-filesystem-using-sdmmc-media",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/sdmmc_fat/readme.html#downloading-and-building-the-application"
  },"60": {
    "doc": "FAT filesystem using SDMMC Media",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/fs/sdmmc_fat/readme.html#setting-up-at91bootstrap-loader"
  },"61": {
    "doc": "FAT filesystem using SDMMC Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Addtional hardware required . | SD Card with FAT32 file system | . Setting up the board . | SDMMC slot used is SDMMC0 (J8) | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/sdmmc_fat/readme.html#setting-up-the-hardware"
  },"62": {
    "doc": "FAT filesystem using SDMMC Media",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED is turned ON if there was no error during creating the directory and copying the file into it | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Green) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/sdmmc_fat/readme.html#running-the-application"
  },"63": {
    "doc": "FAT filesystem using SDMMC Media",
    "title": "FAT filesystem using SDMMC Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat_throughput/readme.html#fat-filesystem-throughput-using-sdmmc-media",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat_throughput/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat_throughput/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/sdmmc_fat_throughput/readme.html#downloading-and-building-the-application"
  },"67": {
    "doc": "FAT filesystem throughput using SDMMC Media",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat_throughput/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/fs/sdmmc_fat_throughput/readme.html#setting-up-at91bootstrap-loader"
  },"68": {
    "doc": "FAT filesystem throughput using SDMMC Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Addtional hardware required . | SD Card with FAT32 file system . | The SD Card should have atleast 10MB of free space for the demo to work | . | . Setting up the board . | SDMMC slot used is SDMMC0 (J8) | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat_throughput/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/sdmmc_fat_throughput/readme.html#setting-up-the-hardware"
  },"69": {
    "doc": "FAT filesystem throughput using SDMMC Media",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | Open the Terminal application (Ex.:Tera term) on the computer. | Connect to the (USB to Serial) COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | The LED is turned ON if there was no error during the file operations . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Green) | . |   |   | . | Calculated throughput values for Aligned and Un-Aligned buffers are dispalyed on console as below: . | Note: The Values showed in the below output may differ slightly when demo is run | . | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat_throughput/readme.html#running-the-application",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat_throughput/readme.html#additional-steps-optional",
    "relUrl": "/apps/fs/sdmmc_fat_throughput/readme.html#additional-steps-optional"
  },"71": {
    "doc": "FAT filesystem throughput using SDMMC Media",
    "title": "FAT filesystem throughput using SDMMC Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/fs/sdmmc_fat_throughput/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/basic_freertos/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#downloading-and-building-the-application"
  },"75": {
    "doc": "FreeRTOS basic",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/basic_freertos/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#setting-up-at91bootstrap-loader"
  },"76": {
    "doc": "FreeRTOS basic",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Setting up the board . | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/basic_freertos/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#setting-up-the-hardware"
  },"77": {
    "doc": "FreeRTOS basic",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera Term) on the computer. | Connect to the (USB to Serial) COM Port and configure the serial settings as follows: . Baud : 115200 . Data : 8 Bits . Parity : None . Stop : 1 Bit . Flow Control : None . | Build the application using its IDE . | Observe the following output on the terminal. | Enter any character on the terminal to run task3. Notice how task1 and task2 are pre-empted by task3 as task3 is of higher priority than task1 and task2. Pressing character ‘l’ or “L’ toggles the on board LED. Notice how task1 and task2 are not run when characters are entered continuously on the terminal. | Press the user switch on the board to run task4. Notice how task4 preempts all other tasks as it is of highest priority. | . Refer to the following table for LED and Switch name: . | Board | LED Name | Switch Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Green) | USER | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/basic_freertos/readme.html#running-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#running-the-application"
  },"78": {
    "doc": "FreeRTOS basic",
    "title": "FreeRTOS basic",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/basic_freertos/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/task_notification_freertos/readme.html#freertos-task-notification",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/task_notification_freertos/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/task_notification_freertos/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtos/freertos/task_notification_freertos/readme.html#downloading-and-building-the-application"
  },"82": {
    "doc": "FreeRTOS Task Notification",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/task_notification_freertos/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/rtos/freertos/task_notification_freertos/readme.html#setting-up-at91bootstrap-loader"
  },"83": {
    "doc": "FreeRTOS Task Notification",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Setting up the board . | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/task_notification_freertos/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtos/freertos/task_notification_freertos/readme.html#setting-up-the-hardware"
  },"84": {
    "doc": "FreeRTOS Task Notification",
    "title": "Running the Application",
    "content": ". | Build the application using its IDE | The LED toggles on success for every 500ms | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X75-EB Evaluation Board | RGB_LED(Green) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/task_notification_freertos/readme.html#running-the-application",
    "relUrl": "/apps/rtos/freertos/task_notification_freertos/readme.html#running-the-application"
  },"85": {
    "doc": "FreeRTOS Task Notification",
    "title": "FreeRTOS Task Notification",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/rtos/freertos/task_notification_freertos/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#console-debug-system-service-using-uart",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#downloading-and-building-the-application"
  },"89": {
    "doc": "Console Debug System Service using UART",
    "title": "Setting up AT91Bootstrap loader",
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to configure, build and run bootstrap loader project and use it to bootstrap the application binaries. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#setting-up-at91bootstrap-loader",
    "relUrl": "/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#setting-up-at91bootstrap-loader"
  },"90": {
    "doc": "Console Debug System Service using UART",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x75_eb.X | SAM9X75-EB Evaluation Board | . |   |   | . Setting up SAM9X75-EB Evaluation Board . Setting up the board . | Connect the DBGU0 J34 on board to the computer using a UART-FTDI cable (to enable debug com port) | Connect the USB port J28 on board to the computer using a micro USB cable (to power the board) | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#running-the-application",
    "relUrl": "/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#running-the-application"
  },"92": {
    "doc": "Console Debug System Service using UART",
    "title": "Console Debug System Service using UART",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html",
    "relUrl": "/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html"
  },"93": {
    "doc": "Using at91boostrap loader with Harmony3 MPU applications",
    "title": "Using at91boostrap loader with Harmony3 MPU applications",
    "content": "MPU harmony3 applications are compiled and linked to execute from external DRAM memory that is available on the corresponding evaluation kit. This require all peripherals and clock leading to the DRAM memory to be configured prior to the application being programmed into DRAM. This is achieved using a bootstrap loader. We use AT91bootstrap loader for this purpose. We have deployed the following pre-built bootstrap binaries inside our application repositories. They can be found under deps folder at the root of the repository. | Binary Name | Description | . | at91bootstrap.elf | Bootstrap which allows debug or run application using MPLABx | . | boot.bin | Bootstrap which allows booting application using an SD Card | . To use at91boostrap to load and run harmony applications from MPLABx, it should be build with “bkpt_none_defconfig” configuration. If you are intrested in building at91bootstrap using MPLABx, you can read about it here. Configure a debug tool . | Open the MPLABx applicaton that you want to debug or run in MPLABx. | Right click on the application project and select properties. This will open the properties window. In the configuration option –&gt; connected hardware tools, select the debugger. Note: if no debugger is connected, click on the “show all” check box and select the supported debugger . | Select the target toolchain and click on apply to save the changes . | This will result in an additional menu option to be available in the configuration tree view called “bootstrap” as shown below: . | . Configure bootstrap . | Click on “Use bootstrap” check box to enable bootstrap support . | Click on the “LOAD” button to load the bootstrap file. This will open a file picker, which allows you to choose the bootstrap binary file. | Navigate to the {repository root}/deps/{board name}/at91bootstrap_binaries folder as explained in the previous section. You should choose “at91bootstrap.elf” file (The “Bootstrap entry address” and the “Bootstrap load address” text box can be left empty as this information will be read from the ELF file automatically) . | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/docs/readme_bootstrap.html#using-at91boostrap-loader-with-harmony3-mpu-applications",
    "relUrl": "/apps/docs/readme_bootstrap.html#using-at91boostrap-loader-with-harmony3-mpu-applications"
  },"94": {
    "doc": "Using at91boostrap loader with Harmony3 MPU applications",
    "title": "Run/Debug MPU applications using MPLABx",
    "content": "You can now Run/Debug the MPU application just like any other MPLABx applications. When executed, MPLABx performs a two stage loading: . Stage 1: Loads the bootstrap loader into the internal SRAM and executes it. This will configure the board specific peripherals and memory . Stage 2: Loads the application into the external DRAM and debugs it. User can perform actions like setting breakpoints, single-stepping etc. When using MPLABx to debug a harmony application, you will face the following limitations: . | Call stack is not fully supported yet, hence stepping in and out of functions may not work correctly. | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/docs/readme_bootstrap.html#rundebug-mpu-applications-using-mplabx",
    "relUrl": "/apps/docs/readme_bootstrap.html#rundebug-mpu-applications-using-mplabx"
  },"95": {
    "doc": "Using at91boostrap loader with Harmony3 MPU applications",
    "title": "Boot to application using SD card",
    "content": "Copy both the application binary named “harmony.bin” and the bootstrap binary named “boot.bin” onto an SD card. Insert the SD card into the SD slot of the evaluation kit and press the reset button. The ROM bootloader will copy the bootstrap binary “boot.bin” into the internal SRAM and executes it. The bootstrap will configure the external DRAM and the required peripherals, then copy the applicaton binary “harmony.bin” into the DRAM and executes it. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/docs/readme_bootstrap.html#boot-to-application-using-sd-card",
    "relUrl": "/apps/docs/readme_bootstrap.html#boot-to-application-using-sd-card"
  },"96": {
    "doc": "Using at91boostrap loader with Harmony3 MPU applications",
    "title": "Using at91boostrap loader with Harmony3 MPU applications",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/docs/readme_bootstrap.html",
    "relUrl": "/apps/docs/readme_bootstrap.html"
  },"97": {
    "doc": "Building AT91Bootstrap project using MPLABx",
    "title": "Building AT91Bootstrap project using MPLABx",
    "content": ". | Open a console and execute the following command to clone at91bootstrap repository into a directory named at91bootstrap.X . git clone https://github.com/linux4sam/at91bootstrap at91bootstrap.X . | Open at91bootstrap.X directory as project in MPLABx . | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/docs/readme_bootstrap_build.html#building-at91bootstrap-project-using-mplabx",
    "relUrl": "/apps/docs/readme_bootstrap_build.html#building-at91bootstrap-project-using-mplabx"
  },"98": {
    "doc": "Building AT91Bootstrap project using MPLABx",
    "title": "Configure compiler",
    "content": ". | Open project properties window, and choose “Makefile” option to configure the compiler: . | Default option is configured to to use ARM gcc. To use xc32, replace all instances of arm-none-eabi- to xc32- as follows . | . NOTE: For the build to be successful, the configured compiler should be available in the system path . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/docs/readme_bootstrap_build.html#configure-compiler",
    "relUrl": "/apps/docs/readme_bootstrap_build.html#configure-compiler"
  },"99": {
    "doc": "Building AT91Bootstrap project using MPLABx",
    "title": "Configure target",
    "content": ". | Open project properties window, and choose “Kconfig” option to configure the build target: . | Click on “LOAD” button and navigate to the configs folder inside at91bootstrap.X directory. You need to choose the default configuration file(defconfig) based on what you need the at91boostrap to do . Debug/Run application from within MPLABx . | Load {evaluation_kit}_bkpt_none_defconfig. For example, on SAM9X75 Evaluation Board, select sam9x75eb_bkptnone_defconfig as the configuration file . | Click on “Apply” and “OK” buttons to configure the project . | You can see that the MPU product is now selected as “SAM9X7” and the primary operation is selected as “Configure and Stop” . | . Load and Run application from an SD card . | Load {evaluation_kit}sd_uboot_defconfig. For example, on SAM9X75 Evaluation Kit, select sam9x75ebsd_uboot_defconfig as the configuration file . | Click on “Apply” and “OK” buttons to configure the project . | You can see that the MPU product is now selected as “SAM9X7” and the primary operation is selected as “Load and launch next software” . | Edit the Option “Next Software Image File Name” from u-boot.bin to harmony.bin . | . | . ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/docs/readme_bootstrap_build.html#configure-target",
    "relUrl": "/apps/docs/readme_bootstrap_build.html#configure-target"
  },"100": {
    "doc": "Building AT91Bootstrap project using MPLABx",
    "title": "Build target",
    "content": "Once the target configuration is applied in the properties window, you can build the at91boostrap just like any other MPLABx project. After the build is complete, you can find the generated binary files under build/binaries directory. ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/docs/readme_bootstrap_build.html#build-target",
    "relUrl": "/apps/docs/readme_bootstrap_build.html#build-target"
  },"101": {
    "doc": "Building AT91Bootstrap project using MPLABx",
    "title": "Building AT91Bootstrap project using MPLABx",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x7/apps/docs/readme_bootstrap_build.html",
    "relUrl": "/apps/docs/readme_bootstrap_build.html"
  },"102": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "![Microchip logo](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_logo.png) ![Harmony logo small](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_mplab_harmony_logo_small.png) # Microchip MPLAB® Harmony 3 Release Notes ## Harmony 3 peripheral library application examples for SAM9X7 family v3.1.0 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications |:-----------------:|:-------------------:| SAM9X75-EB Evaluation Board | 13 | ### New Features - None ### Known Issues - None ### Development Tools - [MPLAB® X IDE v6.05](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - MPLAB® Code Configurator (MCC) v5.3.0 - [MPLAB® XC32 C/C++ Compiler v4.21](https://www.microchip.com/mplab/compilers) ## Harmony 3 driver and system service application examples for SAM9X7 family v3.0.0 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications |:-----------------:|:-------------------:| SAM9X75-EB Evaluation Board | 13 | ### New Features - None ### Known Issues - None ### Development Tools - [MPLAB® X IDE v6.00](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - MPLAB® Code Configurator (MCC) v5.1.9 - [MPLAB® XC32 C/C++ Compiler v4.10](https://www.microchip.com/mplab/compilers) ",
    "url": "http://localhost:4000/core_apps_sam_9x7/release_notes.html",
    "relUrl": "/release_notes.html"
  },"103": {
    "doc": "Harmony 3 driver and system service application examples for SAM9X7 family",
    "title": "Harmony 3 driver and system service application examples for SAM9X7 family",
    "content": "[![MCHP](https://www.microchip.com/ResourcePackages/Microchip/assets/dist/images/logo.png)](https://www.microchip.com) # Harmony 3 driver and system service application examples for SAM9X7 family MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 driver and system service application examples for SAM9X7 family - [Release Notes](/core_apps_sam_9x7/release_notes.html) - [MPLAB® Harmony License](/core_apps_sam_9x7/mplab_harmony_license.html) To clone or download these applications from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_9x7) and then click **Clone** button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these [instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki). ## Contents Summary | Folder | Description | --- | --- | apps | Contains driver and system service example applications | docs | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/core_apps_sam_9x7/) of this repository for viewing it online. | ## Code Examples The following applications are provided to demonstrate the typical or interesting usage models of one or more peripheral libraries. | Name | Description | ---- | ----------- | [I2C driver synchronous - I2C EEPROM](/core_apps_sam_9x7/apps/driver/i2c/sync/i2c_eeprom/readme.html) | This example application shows how to use the I2C driver in synchronous mode to perform operations on the EEPROM | [I2C EEPROM AT24 driver - EEPROM Read Write](/core_apps_sam_9x7/apps/driver/i2c_eeprom/at24/at24_eeprom_read_write/readme.html) | This example application shows how to use the AT24 driver to perform read and write operations on AT24 series of EEPROM | [SDMMC driver asynchronous - SDMMC Read Write](/core_apps_sam_9x7/apps/driver/sdmmc/async/sdmmc_read_write/readme.html) | This example application shows how to use the SDMMC driver in asynchronous mode to perform block operations on the SD Card Media | [SPI EEPROM AT25 driver - EEPROM Read Write](/core_apps_sam_9x7/apps/driver/spi_eeprom/at25/at25_eeprom_read_write/readme.html) | This example application shows how to use the AT25 driver to perform read and write operations on AT25 series of EEPROM | [USART driver asynchronous - USART echo](/core_apps_sam_9x7/apps/driver/usart/async/usart_echo/readme.html) | This example echoes the received characters over the console using the USART driver in asynchronous mode | [USART driver synchronous - USART echo](/core_apps_sam_9x7/apps/driver/usart/sync/usart_echo/readme.html) | This example echoes the received characters over the console using the USART driver in synchronous mode | [FAT filesystem using RAM Media](/core_apps_sam_9x7/apps/fs/ram_fat/readme.html) | This application shows an example of using the MPLAB Harmony File System to access RAM media | [FAT filesystem using SDMMC Media](/core_apps_sam_9x7/apps/fs/sdmmc_fat/readme.html) | This application shows an example of using the MPLAB Harmony File System to access and modify the contents of a SD card using the SDMMC driver | [FAT filesystem throughput using SDMMC Media](/core_apps_sam_9x7/apps/fs/sdmmc_fat_throughput/readme.html) | This application calculates throughput by Writing and Reading data into a Sd-Card at High Speed using the MPLAB Harmony File System and the SDMMC driver | [FreeRTOS basic](/core_apps_sam_9x7/apps/rtos/freertos/basic_freertos/readme.html) | This example application demonstrates context switching between four tasks of different priorites. Two tasks run periodically while the other two tasks are event driven | [FreeRTOS Task Notification](/core_apps_sam_9x7/apps/rtos/freertos/task_notification_freertos/readme.html) | This example application is to illustrate the FreeRTOS Task Notification feature which is used as a light weight binary semaphore | [Console Debug System Service using UART](/core_apps_sam_9x7/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html) | This example application demonstrates the UART based console and debug system service | [Time System Service multi-client](/core_apps_sam_9x7/apps/system/time/sys_time_multiclient/readme.html) | This example application demonstrates the multi-client system timer functionality | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_9x7/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/core_apps_sam_9x7.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_9x7/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/core_apps_sam_9x7.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_9x7/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/core_apps_sam_9x7.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_9x7/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/core_apps_sam_9x7.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/core_apps_sam_9x7.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/core_apps_sam_9x7.svg?style=social)]() ",
    "url": "http://localhost:4000/core_apps_sam_9x7/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "core_apps_sam_9x7";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 driver and system service application examples for SAM9X7 family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/core_apps_sam_9x7/assets/css/just-the-docs-' + theme + '.css');
}
