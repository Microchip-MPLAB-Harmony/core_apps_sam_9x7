...
- Insert [EEPROM 4 Click](https://www.mikroe.com/eeprom-4-click) board into MIKROBUS1 (J22) Connector.
- Connect the USB port J2 on board to the computer using a micro USB cable (to power the board)

## Running the Application

1. Build and program the application using its IDE
2. The BLUE LED is turned ON when the value read from EEPROM matches with the written data

Refer to the following table for LED name:

| Board | LED Name |
| ----- | -------- |
|  [SAM9X75-Curiosity Development Board]()  | RGB_LED(Blue) |
|||